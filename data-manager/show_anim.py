...
if __name__ == '__main__':
    ...
    try:
        ...
        parser.add_option('--verbose', action='store_false', default=False, help='verbose output')
        parser.add_option('--inputdir', help='Dir containing the logs', default=None)
        parser.add_option('--outputdir', help='dir to save the plots')
        parser.add_option('--timeslotsize', help='time between two refreshes of the animator')
        ...
        parser.add_option('--baudrate', help='baudrate utilized', default=1500000)
        parser.add_option('--packet_size', help='packet_size in bits', default=16*8)
